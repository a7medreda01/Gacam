...
export const TRANSLATIONS: Record<string, Record<string, string>> = {
  ar: {
    ...
    'NAV.VOLUNTEER': 'التطوع والدعم المجتمعي',
    ...
    'NAV.TRAINING_PROGS': 'برامج التدريب والتطوير',
    'NAV.VERIFY': 'التحقق والامتثال',
    'NAV.MORE': 'المزيد',
    ...
    'HOME.SERVICES_TITLE': 'خدماتنا المهنية وبرامج العضوية والتطوير المهني',
    'HOME.SERVICES_SUB': 'تقدم الهيئة مجموعة من الخدمات المتخصصة التي تشمل الدعم المهني للإعلاميين، البرامج التدريبية المتقدمة، وإصدار بطاقات العضوية للممارسين في القطاع الإعلامي.',
    ...
    'HOME.LATEST_NEWS': 'أحدث مواد المركز الإعلامي المعتمدة',
    'HOME.VIEW_ALL_NEWS': 'استعراض الأخبار والبيانات الرسمية',
    ...
    'PAYMENT.DESC': 'يرجى تحويل رسوم المعاملة لحساب الهيئة الرسمي عبر البريد الإلكتروني المعتمد: media@gacam.ca ومن ثم تدوين رقم العملية ورفع الإيصال في النموذج أدناه.',
    ...
    'FOOTER.DESC': 'الهيئة العامة للإعلام المرئي والمسموع الخليجي والعربي في كندا تعمل تحت مظلة جمعية الثقافة والفنون الخليجية في كندا، وتُعد الذراع الإعلامية للجمعية في دعم العمل الصحفي وتنظيم البرامج وتعزيز التكامل في القطاع.',
  ...
  en: {
    ...
    'NAV.VOLUNTEER': 'Volunteer & Support',
    'NAV.TRAINING': 'Training Programs',
    'NAV.NEWS': 'Media Center',
    ...
    'NAV.TRAINING_PROGS': 'Training & Development',
    ...
    'HOME.SERVICES_TITLE': 'Professional Services & Membership Programs',
    'HOME.SERVICES_SUB': 'The Authority provides a specialized suite of services including professional support for media personnel, advanced training programs, and membership cards for practitioners in the media sector.',
    ...
    'HOME.LATEST_NEWS': 'Latest Media Center Materials & Statements',
    'HOME.VIEW_ALL_NEWS': 'View Media Center Archives',
    ...
    'PAYMENT.DESC': 'Please send the required transaction amount via Interac Email Transfer to our central office at: media@gacam.ca. Once sent, upload the receipt below.',
    ...
    'FOOTER.DESC': 'The Gulf & Arab General Commission for Audiovisual Media in Canada operates under the umbrella of the Gulf & Arab Culture & Arts Association in Canada, and is the media arm of the association in supporting journalistic work, organizing programs, and enhancing integration in the sector.',
